CREATE TABLE [dbo].[RoyException](
	...
	[ExceptionSource] [text] NULL,
	[ExceptionHelpLink] [varchar](250) NULL,
	[ExceptionJSON] [text] NULL,
 ...
 CONSTRAINT [PK_RoyException] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
ALTER TABLE [dbo].[RoyException] ADD  CONSTRAINT [DF_RoyException_CreatedDate]  DEFAULT (getdate()) FOR [CreatedDate]
GO
